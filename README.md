...
│   ├── ContarPalabra.java             # Count word occurrences
│   ├── DividirCadenaFrutas.java       # Split a fruit string
│   ├── EsUnPalindromo.java            # Check if a string is a palindrome
│   ├── Main.java                      # Entry point
│   ├── ManipulacionDeCadenas.java     # String manipulation operations
│   ├── OperadorTernario.java          # Ternary operator examples
│   ├── ReemplazarTextoURL.java        # Replace text in URLs
